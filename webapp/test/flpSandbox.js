		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GFC Members",
									"targetURL": "#ndbsgfcgfcmembersui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ndbsgfcgfcmembersui-display": {
								"semanticObject": "ndbsgfcgfcmembersui",
								"action": "display",
								"description": "GFC Members",
								"title": "GFC Members",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ndbs.gfc.gfcmembersui",
									"url": sap.ui.require.toUrl("ndbs/gfc/gfcmembersui")
								}
							}
						}
					}
